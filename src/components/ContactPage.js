...
export default function ContactPage(){
    return (<div  className="contact-parent">
        ...
        <div className="contact-icon">
           <a href="https://github.com/tinastouch/" target="_blank">
                <img src={contacticon1} className="contact-icon-img" alt="Github" />
            </a>
        </div>

        <div className="contact-icon">
           <a href="https://ca.linkedin.com/in/tina-sutherland-3017b262" target="_blank">
                <img src={contacticon2} className="contact-icon-img" alt="Linkedin" />
            </a>
        </div>

        <div className="contact-icon">
           <a href="mailto:tinastouch@gmail.com" target="_blank">
                <img src={contacticon3} className="contact-icon-img" alt="Email" />
            </a>
        </div>

        <div className="contact-icon">
           <a href="https://www.instagram.com/tinastouch/" target="_blank">
